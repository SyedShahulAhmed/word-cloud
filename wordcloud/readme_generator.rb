...
class ReadmeGenerator
  WORD_CLOUD_URL = 'https://raw.githubusercontent.com/SyedShahulAhmed/word-cloud/main/wordcloud/wordcloud.png'
  ADDWORD = 'add'
...
<img src="#{WORD_CLOUD_URL}" alt="WordCloud" width="100%">
  ...
  def previous_cloud_url
    ...
    "https://github.com/SyedShahulAhmed/word-cloud/blob/main/previous_clouds/previous_clouds.md##{url_end}"
  end
