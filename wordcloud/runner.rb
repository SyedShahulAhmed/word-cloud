...
class Runner
  ...
  USER = 'SyedShahulAhmed'

  def initialize(
    github_token:,
    issue_number:,
    issue_title:,
    repository: "SyedShahulAhmed/word-cloud",
    user:,
    development: false
  )
  ...
  def generate_cloud
    ...
    result = system('sort -R wordcloud/wordlist.txt | wordcloud_cli --imagefile wordcloud/wordcloud.png --prefer_horizontal 0.5 --repeat --fontfile wordcloud/Montserrat-Bold.otf --background black --colormask images/colourMask.png --width 700 --height 400 --regexp "\w[\w\' !?#@+-.]+" --no_collocations --min_font_size 10 --max_font_size 120')
